...
\item Napiš funkci, který převede římské číslice na číslo (\verb+int+).
...
\item Had byl pyšný na to, že je v abecedě první.
    ...
    \emph{
        ...
        \begin{itemize}
            ...
            \item Vytvoř seznam dvojic (klíč, hodnota).
...
\item Napiš funkci \verb+pohyb+, která dostane seznam souřadnic a světovou stranu
  ...
  \verb+pohyb([(0, 0)], 's') == [(0, 0), (0, 1)]+
\\\verb+pohyb([(0, 0), (0, 1)], 's') == [(0, 0), (0, 1), (0, 2)]+
\\\verb+pohyb([(0, 0), (0, 1), (0, 2)], 'z') == [(0, 0), (0, 1), (0, 2), (1, 2)]+
\\\verb+pohyb([(0, 0), (0, 1), (0, 2), (1, 2)], 'j') == [(0, 0), (0, 1), (0, 2), (1, 2), (1, 1)]+
