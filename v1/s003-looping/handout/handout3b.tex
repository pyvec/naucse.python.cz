...
Tohle je čtvrtá sada úkolů. Udělej si Gitový repozitář, do kterého si ukládej řešení.
Jakmile ti bude nějaké řešení fungovat, ulož si ho jako revizi v Gitu.
\\(Občas je to připomenuto i u jednotlivých úkolů.)
...
\startsection{Následující sada úkolů není jednoduchá, ale uděláš-li ji, pochopíš různá použití cyklu for.}
...
\item Máš-li ráda matematiku*, a nebojíš-li se výzvy, načti od uživatele číslo $n$ a:
    ...
    \end{itemize}
    \emph{\small * t.j. nemáš-li ráda matematiku, nedělej tenhle úkol :)}
...
\hfill~%
\begin{tikz}
\node[rotate=180]{Možné řešení úkolu \ref{cisloradku}: \texttt{cislo\_radku} };
\end{tikz}
