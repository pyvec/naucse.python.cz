...
\item Napiš funkci \texttt{tah}, která dostane řetězec s herním polem,
    číslo políčka (0-19), a synmbol (\texttt{x} nebo \texttt{o}),
    a vrátí herní pole s daným symbolem umístěným na danou pozici.
    \\\emph{Můžeš využít nějakou funkci, kterou jsme už napsaly?}

\item Napiš funkci \texttt{tah\_hrace}, která dostane řetězec s herním polem,
    se zeptá hráče, na kterou pozici chce hrát, a vrátí herní pole
