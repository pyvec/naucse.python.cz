...
@app.route('/courses/<course_name>/static/<file_name>')
def course_file(path):
    file = 'courses/' + course_name + '/static/' + file_name
    if os.path.exists(os.path.join(app.root_path, file)):
        return file
    abort(404)
